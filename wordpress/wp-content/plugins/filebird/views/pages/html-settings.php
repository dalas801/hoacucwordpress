    ...
    <table class="form-table">
      ...
      <tr>
        <th scope="row">
          ...
          <p class="description" style="font-weight: 400"><?php _e('Your old folders were imported automatically. If any error occurs, you can try re-import here.', 'filebird'); ?></p>
        </th>
        <td>
